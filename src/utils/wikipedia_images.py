...
ARTICLE_MAPPINGS = {
    ...
    "桃": "Prunus_persica",
    "チューリップ": "Tulip",
    "スイートピー": "Lathyrus_odoratus",
    "レンギョウ": "Forsythia",
    "モクレン": "Magnolia",
    "ハナミズキ": "Cornus_florida",
    "パンジー": "Viola_tricolor",
    "芝桜": "Phlox_subulata",
    "スズラン": "Convallaria_majalis",
    "ライラック": "Syringa_vulgaris",
    "タンポポ": "Taraxacum",
    "ヒヤシンス": "Hyacinthus_orientalis",
    "アネモネ": "Anemone",
    "フリージア": "Freesia",
    "アイリス": "Iris_(plant)",
    "ラナンキュラス": "Ranunculus",
    "ユリ": "Lilium",
    "カーネーション": "Dianthus_caryophyllus",
    "バラ": "Rose",
    "ラベンダー": "Lavandula",
    "ハイビスカス": "Hibiscus",
    "ポピー": "Papaver",
    "カスミソウ": "Gypsophila_paniculata",
    "デイジー": "Bellis_perennis",
    "ペチュニア": "Petunia",
    "マリーゴールド": "Tagetes",
    "サルビア": "Salvia",
    "ジニア": "Zinnia",
    ...
    "アガパンサス": "Agapanthus",
    "ダリア": "Dahlia",
    "金木犀": "Osmanthus_fragrans",
    "ススキ": "Miscanthus_sinensis",
    "リンドウ": "Gentiana",
    "ワレモコウ": "Sanguisorba",
    "ガーベラ": "Gerbera",
    "曼珠沙華": "Lycoris_radiata",
    "ケイトウ": "Celosia",
    "ホトトギス": "Tricyrtis",
    "シクラメン": "Cyclamen",
    "クレマチス": "Clematis",
    "エーデルワイス": "Leontopodium",
    "ユーカリ": "Eucalyptus",
    "オリーブ": "Olive",
    "ローズマリー": "Rosemary",
    "ミモザ": "Acacia_dealbata",
    "芍薬": "Paeonia_lactiflora",
    "牡丹": "Paeonia_suffruticosa",
    "サクラソウ": "Primula_sieboldii",
    "ポインセチア": "Poinsettia",
    "クリスマスローズ": "Hellebore",
    "スノードロップ": "Galanthus",
    "蝋梅": "Chimonanthus_praecox",
    "寒椿": "Camellia_sasanqua",
    "松": "Pinus",
    "パンパスグラス": "Cortaderia_selloana",
    "コルチカム": "Colchicum_autumnale",
